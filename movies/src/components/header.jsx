...
function Navbar() {
  const active =
    "text-base block py-2 px-3 text-white bg-blue-500 rounded md:bg-transparent md:text-blue-500 md:p-0 md:dark:text-blue-500";
  const inactive =
    ...
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2">
          <button className="pr-5" onClick={()=>{setdarkmode(!darkmode)}}>
            {darkmode ? (<IoSunny color="white" size={25} />):<MdDarkMode size={25}/>}
          </button>
          <button
